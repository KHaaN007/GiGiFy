            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-indigo-50 shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <p className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Don`t have an account? <Link
                        to='/register'
                        href="javascript:void(0)" className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Sign up here</Link></p>
                    <button onClick={handleGoogleLogin} aria-label="Continue with google" role="button" className="focus:outline-none buttonOne focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
                    ...
                    <form onSubmit={handleLogin} action="#" method="POST">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                type="email"
                                id="useremail"
                                name="email" className="w-full text-black border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" />
                        </div>
                        {/* <!-- Password Input --> */}
                        <div className="mb-4">
