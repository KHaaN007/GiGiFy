            ...
            <div className="h-screen flex items-center justify-center">
                <div className="lg:buttonOne">
                    <div className="text-center">
                        ...
                        <h1 className="mt-3 lg:text-[3.5rem] font-bold leading-[4rem] tracking-tight text-black">Find your dream JOb from&nbsp;<span className="text-7xl text-indigo-600 font-serif ">GiGify</span></h1>
